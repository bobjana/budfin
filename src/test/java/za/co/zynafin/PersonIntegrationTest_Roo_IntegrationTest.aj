...
import za.co.zynafin.PersonDataOnDemand;
...
privileged aspect PersonIntegrationTest_Roo_IntegrationTest {
    ...
    public void PersonIntegrationTest.testCountPeople() {
        ...
        long count = za.co.zynafin.Person.countPeople();
    ...
    public void PersonIntegrationTest.testFindPerson() {
        ...
        za.co.zynafin.Person obj = za.co.zynafin.Person.findPerson(id);
    ...
    public void PersonIntegrationTest.testFindAllPeople() {
        ...
        java.util.List<za.co.zynafin.Person> result = za.co.zynafin.Person.findAllPeople();
    ...
    public void PersonIntegrationTest.testFindPersonEntries() {
        ...
        java.util.List<za.co.zynafin.Person> result = za.co.zynafin.Person.findPersonEntries(0, (int)count);
    ...
    public void PersonIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Person' failed to initialize correctly", dod.getRandomPerson());
        za.co.zynafin.Person obj = dod.getNewTransientPerson(Integer.MAX_VALUE);
    ...
    public void PersonIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Person' with identifier '" + id + "'", za.co.zynafin.Person.findPerson(id));
    }
